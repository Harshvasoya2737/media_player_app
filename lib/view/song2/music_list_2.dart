...
class music_show_2 extends StatefulWidget {
  const music_show_2({super.key});

  @override
  State<music_show_2> createState() => _music_show_2State();
}

class _music_show_2State extends State<music_show_2> {
  @override
...
class _AudioPageState extends State<AudioPage> {
  ...
  void runFilter(String enteredKey) {
    ...
    if (enteredKey.isEmpty) {
      results = musicList.sublist(6);
    } else {
      results = musicList.sublist(6).where((element) =>
